...
class MockKubernetes:
    ...
    def get_pods(self, namespace: str = 'default', label_selector: Optional[str] = None) -> list:
        """Get pods from the mock state."""
        return self.state.list_resources(namespace, "Pod", label_selector)
    
    def get_deployments(self, namespace: str = 'default', label_selector: Optional[str] = None) -> list:
        """Get deployments from the mock state."""
        return self.state.list_resources(namespace, "Deployment", label_selector)
    
    def get_services(self, namespace: str = 'default', label_selector: Optional[str] = None) -> list:
...
@contextmanager
def mock_kubernetes(initial_state: Optional[Dict[str, Any]] = None) -> Generator[MockKubernetes, None, None]:
    """
