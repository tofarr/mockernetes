...
class MockKubernetesState:
    ...
    def __init__(self):
        ...
        self.cluster_resources: Dict[str, Dict[str, Any]] = {}  # For cluster-scoped resources
    ...
    def create_resource(self, namespace: Optional[str], kind: str, resource: Any) -> Any:
    ...
    def list_resources(self, namespace: Optional[str], kind: str, label_selector: Optional[str] = None) -> List[Any]:
    ...
    def update_resource(self, namespace: Optional[str], kind: str, name: str, resource: Any) -> Any:
    ...
    def _filter_by_labels(self, resources: List[Any], label_selector: str) -> List[Any]:
        ...
        for resource in resources:
            if hasattr(resource, 'metadata') and resource.metadata and resource.metadata.labels:
                match = True
    ...
    def _add_event(self, namespace: Optional[str], kind: str, name: str, action: str) -> None:
...
class MockApiClient:
    ...
    def call_api(self, *args, **kwargs):
        ...
        raise NotImplementedError("Use specific API classes instead of call_api directly")
